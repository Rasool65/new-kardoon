import { URL_BLOG, URL_CHAT, URL_CONVERSATION, URL_TECHNICIAN_MISSION } from '@src/configs/urls';
  ...
  return (
    <>
      <nav>
        ...
        <div className={`login-box mr-auto ${checkRole('TECHNICIAN') && 'technesian-login'}`}>
