import SelectCity from '../../pages/province/SelectCity';
import { useSelector, useDispatch } from 'react-redux';
import { RootStateType } from '@src/redux/Store';
import { useNavigate } from 'react-router-dom';
import { URL_CONVERSATION, URL_LOGIN, URL_MAIN, URL_USER_PROFILE } from '@src/configs/urls';
    ...
    <>
      ...
      <nav className="desktop-menu">
        <div className="container menu-bar">
          ...
          {/* <div className="login-box">
            <a href="tel:+98214700" className="call-box">
              <p className="menu-item">0214700</p>
              <img src={require(`@src/scss/images/icons/${color}-vectori344-6d8t.svg`)} alt="VectorI344" />
            </a>
          </div> */}
        </div>
      </nav>
