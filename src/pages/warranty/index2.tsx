      ...
      <div className="home-warranty-selector">
        <div className="row">
          <div className="col-12 col-lg-6 p-0">
            ...
            {/* close-box */}
            <div id="" className={`warranty-selector-card  warranty-selector-parent`}>
              <div className="warranty-selector-header">
                <div className="card-title">
                  <div>لوازم خانگی بزرگ</div>
                </div>
              </div>
                  ...
                  homeWarrantyProducts.map((item: IHomeWarrantyProductsModelResult, index: number) => {
                    return (
                      <div id={`accordion${index}`} className={`warranty-selector-card ${!item.required && 'close-box'}`}>
                        <div className="warranty-selector-header">
                          <div className="card-title warranty-has-icon">
                        ...
                        <li>
                          ...
                          <div>{UtilsHelper.threeDigitSeparator(item.comprehensiveCoverageValue)}</div>
                            ...
                            <li>
                              <span>سریال</span>
                              <div>
                                <input className="input-warranty" placeholder="شماره سریال" type="number" />
                              </div>
                            </li>
                            ...
                            <li>
                              ...
                              <div className="d-flex">
                                ...
                                />
                                <input className="input-warranty mr-2" placeholder="مرکز گارانتی" type="number" />
                              </div>
                            </li>
                          </ul>
                          ...
                          <ul>
                            <li>
                              <textarea className="input-warranty" name="" id=""></textarea>
                            </li>
                          </ul>
                          ...
                          <ul className="optional">
                            <li>
                              <span>اصالت دستگاه</span>
                              <div className="d-flex">
                                <input id={`gaurantee#${item.uuid}`} defaultChecked={false} type="checkbox" />
                              </div>
                            </li>
                            <li>
                              <span>استاندارد محل نصب</span>
                              <div className="d-flex">
                                <input id={`gaurantee#${item.uuid}`} defaultChecked={false} type="checkbox" />
                              </div>
                            </li>
                            ...
                            <li>
                              <span>تست سرمایش دستگاه</span>
                              <div className="d-flex">
                                <input id={`gaurantee#${item.uuid}`} defaultChecked={false} type="checkbox" />
                              </div>
                            </li>
                            <li>
                              <span>تست آبریزی و یخسازی</span>
                              <div className="d-flex">
                                <input id={`gaurantee#${item.uuid}`} defaultChecked={false} type="checkbox" />
                              </div>
                            </li>
                          ...
                          <ul>
                            ...
                            <li className="align-items-center">
                              <span>داخل کابین</span>
                              <span className="range-number">50%</span>
                              <input className="range-input" type="range" id="vol" name="vol" min="0" max="100" />
                            </li>
                            <li className="align-items-center">
                              <span>بدنه سمت راست</span>
                              <span className="range-number">50%</span>
                              <input className="range-input" type="range" id="vol" name="vol" min="0" max="100" />
                            </li>
                            <li className="align-items-center">
                              <span>بدنه سمت چپ</span>
                              <span className="range-number">50%</span>
                              <input className="range-input" type="range" id="vol" name="vol" min="0" max="100" />
                            </li>
                            <li className="align-items-center">
            ...
            <div id="" className={`warranty-selector-card warranty-selector-parent close-box`}>
              <div className="warranty-selector-header">
                <div className="card-title">
                  <div>لوازم خانگی خرد</div>
                </div>
              </div>

              <div className="warranty-selector-details">??</div>
            </div>

            <div id="" className={`warranty-selector-card warranty-selector-parent close-box`}>
              <div className="warranty-selector-header">
                <div className="card-title">
                  <div>تاسیسات برقی</div>
                </div>
              </div>
