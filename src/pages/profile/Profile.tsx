...
import {
  ...
  APIURL_GET_USER_INFO,
  APIURL_UPDATE_PROFILE,
  APIURL_UPDATE_PROFILE_FORMDATA,
...
const Profile: FunctionComponent<IProfilePageProp> = ({ handleClickTab }) => {
  ...
  const [userInfo, setUserInfo] = useState<IUserInfoResultModel>();
  ...
  const GetUserInfo = () => {
    ...
    httpRequest.postRequest<IOutputResult<IUserInfoResultModel>>(`${APIURL_GET_USER_INFO}`, body).then((result) => {
                ...
                <div className="row">
                  ...
                  <div className="col-12 col-md-6 col-lg-3">
                    ...
                    <Controller
                      name="firstName"
                      control={control}
                      defaultValue={userInfo?.user?.profile?.firstName || ''}
                      render={({ field }) => (
                        <>
                          <Input
                  ...
                  <div className="col-12 col-md-6 col-lg-3">
                    ...
                    <Controller
                      name="lastName"
                      control={control}
                      defaultValue={userInfo?.user.profile?.lastName || ''}
                      render={({ field }) => (
                        <>
                          <Input
                            className="account-data-input"
                  ...
                  <div className="col-12 col-md-6 col-lg-3">
                    ...
                    <Controller
                      name="email"
                      control={control}
                      defaultValue={userInfo?.user?.profile?.email || ''}
                      render={({ field }) => (
                        <>
                          <Input
                            className="account-data-input"
                  ...
                  <div className="col-12 col-md-6 col-lg-3">
                    ...
                    <Controller
                      name="nationalCode"
                      control={control}
                      defaultValue={userInfo?.user.profile?.nationalCode || ''}
                      render={({ field }) => (
                        <>
                          <Input
                            className="account-data-input"
                  ...
                  <div className="col-12 col-md-6 col-lg-3">
                    ...
                    <Controller
                      name="birthDate"
                      control={control}
                      defaultValue={DateHelper.isoDateTopersian(userInfo?.user?.profile?.birthDate)}
                  ...
                  <div className="col-12 col-md-6 col-lg-3">
                    ...
                    <Controller
                      name="phoneNumber"
                      control={control}
                      defaultValue={userInfo?.user?.profile?.phoneNumber || ''}
                      render={({ field }) => (
                        <>
                          <Input
                            className="account-data-input"
                  ...
                  {/* <div className="col-12 col-md-6 col-lg-3">
                    <p className="item-label">شهر محل سکونت</p>
                    <Controller
                      name="residenceCityName"
                      control={control}
                      defaultValue={userInfo?.user.profile?.residenceCityName}
                      render={({ field }) => (
                        <>
                          <Input
                            className="account-data-input"
                            type="text"
                            placeholder={t('شهر محل سکونت خود را وارد نمایید')}
                            autoComplete="off"
                            invalid={errors.nationalCode && true}
                            {...field}
                          />
                  ...
                  <div className="col-12 col-md-6 col-lg-3">
                    ...
                    <Controller
                      name="homeAddress"
                      control={control}
                      defaultValue={userInfo?.user.profile?.homeAddress || ''}
                      render={({ field }) => (
                        <>
                          <Input
                  ...
                  <div className="col-12 col-md-6 col-lg-3">
                    ...
                    <Controller
                      name="workAddress"
                      control={control}
                      defaultValue={userInfo?.user.profile?.workAddress || ''}
                      render={({ field }) => (
                        <>
                          <Input
                            className="account-data-input p-2"
                  ...
                  <div className="col-12 col-md-6 col-lg-3">
                    ...
                    <Controller
                      ...
                      control={control}
                      defaultValue={userInfo?.user.profile?.intrductionInfo?.introductionCode || ''}
                      render={({ field }) => (
                        <>
                          <Input
                            className="account-data-input"
                      ...
                      render={({ field }) => (
                        <>
                          <Select
                            ...
                            isSearchable={true}
                            {...field}
                            defaultInputValue={userInfo?.user.profile?.intrductionInfo?.introMethodTitle || ''}
                            onChange={(e: any) => {
