...
import { color, font } from '@src/redux/reducers/themeReducer';

interface SelectThemeProps {}

const SelectTheme: FunctionComponent<SelectThemeProps> = () => {
  const themeColor = useSelector((state: RootStateType) => state.theme.color);
  const themeFont = useSelector((state: RootStateType) => state.theme.font);
    ...
    <>
      <div className="theme-btnbox">
        ...
        <div className="d-flex">
          <button className="btn btn-blue" onClick={() => dispatch(color('blue'))}>
            آبی
          </button>
          <button className="btn btn-red" onClick={() => dispatch(color('red'))}>
            قرمز
          </button>
        </div>
        <div className="d-flex">
